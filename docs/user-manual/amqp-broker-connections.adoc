...
WARNING: AMQP Senders and Receivers are deprecated and this configuration will be removed in a future release, users are advised to migrate to the newer AMQP bridging configuration described later in this document.
...
WARNING: AMQP Peer functionality is deprecated and will be removed in a future broker release.
